...
# Dataset root that matches the current PST dataloader structure:
...
if [[ ! -f "$PRETRAINED_PATH" ]]; then
  ...
  echo
  echo "Then either:"
  echo "  1. Place it at $PRETRAINED_PATH"
  echo "  2. Or override PRETRAINED_PATH=/your/path/to/swinv2_tiny_patch4_window16_256.pth"
  exit 1
fi
...
echo "  recursive_rerouting=True"
echo "  loss_balance_weight=0.01"
echo "  loss_aux_weight=0.2"
