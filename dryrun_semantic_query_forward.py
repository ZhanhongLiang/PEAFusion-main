"""
Dry-run script for PEAFusion with SemanticQueryDecoder enabled.
"""
...
def build_cfg():
    ...
    cfg.MODEL.MASK_FORMER.DECODER_TYPE = "semantic_query"
    cfg.freeze()
    return cfg
...
def main():
    ...
    print("semantic_query seg logits shape:", tuple(sem_seg.shape))
